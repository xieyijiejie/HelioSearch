...
public class HS {
    ...
    static {
        ...
        System.out.println("leo.li-leo.li-leo.li(cwd):" + cwd);
        System.out.println("leo.li-leo.li-leo.li(solrDir):" + solrDir);
        ...
        try {
            ...
            if (!found && solrDir != null) {
                ...
                System.out.println("leo.li-leo.li-leo.li(1):" + file.getAbsolutePath());
                if (file.exists()) {
                    found = true;
            ...
            if (!found) {
                ...
                System.out.println("leo.li-leo.li-leo.li(2):" + file.getAbsolutePath());
                if (file.exists()) {
                    found = true;
                    System.load(file.getAbsolutePath());
                }
            ...
            if (!found) {
                ...
                System.out.println("leo.li-leo.li-leo.li(3):" + file.getAbsolutePath());
                if (file.exists()) {
                    found = true;
                    System.load(file.getAbsolutePath());
                }
            ...
            if (!found) {
                // intellij tests CWD will be at the root of lucene/solr, so point it at solr/example/native
                file = new File(cwd + File.separator + "solr" + File.separator + "example" + File.separator + "native" + File.separator + libName);
                System.out.println("leo.li-leo.li-leo.li(4):" + file.getAbsolutePath());
                if (file.exists()) {
                    found = true;
                    System.load(file.getAbsolutePath());
                }
